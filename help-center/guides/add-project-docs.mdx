...
<Columns cols={3}>
  ...
  <Card title="Troubleshooting" href="/help-center/troubleshooting/cannot-invite-team" icon="help-circle">
...
For path or render problems, see [Troubleshooting: Cannot Invite Team](/help-center/troubleshooting/cannot-invite-team).
