...
Confirm the content change, metadata, and links before merging.
...
<Card title="Docs workflow" href="/quickstart" icon="book-open" horizontal={true}>
See how documentation pages fit into the broader documentation workflow.
</Card>

<Card title="Content tooling" href="/ci-cd-pipelines" icon="settings" horizontal={true}>
