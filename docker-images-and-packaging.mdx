...
description: >-
  How each implemented service is containerized today, including build stages,
  runtime commands, exposed ports, and image publishing through GitHub Actions.
---
...
<Columns cols={2}>
  ...
  <Card title="Service versioning" href="/service-versioning" icon="git-branch" cta="Open page" />
</Columns>
