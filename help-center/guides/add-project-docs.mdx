...
<Columns cols={3}>
  ...
  <Card title="Cannot invite team" href="/help-center/troubleshooting/cannot-invite-team" icon="help-circle">

    Use the team-invitation troubleshooting path when collaboration setup blocks project docs work.
...
For team invitation problems, see [Cannot Invite Team](/help-center/troubleshooting/cannot-invite-team).
