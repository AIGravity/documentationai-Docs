...
This page reflects the route currently implemented in `apps/ai-service/main.py`.
...
- **`405 Method Not Allowed`** — Returned when you use an unsupported method on the existing `/health` route.
