...
<Columns cols={3}>
  ...
  <Card title="Troubleshooting" href="/integrations#troubleshooting" icon="help-circle">
...
For path or render problems, see [Integrations troubleshooting](/integrations#troubleshooting).
