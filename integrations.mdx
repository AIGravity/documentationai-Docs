...
Because exact event names are not sourced here, define your own event contract around the actions you already need, such as content updates, page publishing, or build completion. Keep the payload stable and small so downstream automation stays predictable.
...
<Card title="Docs workflow" href="/ci-cd-pipelines" icon="book-open" horizontal={true}>
See how documentation pages fit into the broader documentation workflow.
</Card>

<Card title="Content tooling" href="/repository-automation-scripts" icon="settings" horizontal={true}>
