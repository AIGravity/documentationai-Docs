...
This page documents the FastAPI AI service endpoint confirmed in the AIGravity core repository. The service currently exposes one endpoint: `GET /health`.
...
- **`404 Not Found`** — Returned when you request a path or method combination that is not defined.
