...
Add project documentation as MDX, keep paths consistent, and verify the page is reachable from navigation.

</Card>

<Card title="Content tooling" href="/integrations#markdown-and-mdx-toolchain-integration" icon="settings" horizontal={true}>

Review the Markdown and MDX checks that keep content valid before publishing.
