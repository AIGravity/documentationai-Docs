...
<Columns cols={3}>
  ...
  <Card title="Team access troubleshooting" href="/help-center/troubleshooting/cannot-invite-team" icon="help-circle">

    Use this fix when a contributor cannot be invited to the team that owns the project docs.
...
If a teammate cannot be added to the workspace or project team that maintains the docs, see [Troubleshooting: Cannot Invite Team](/help-center/troubleshooting/cannot-invite-team).
