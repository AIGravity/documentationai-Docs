...
<Columns cols={2}>
  <Card title="CI/CD pipelines" href="/ci-cd-pipelines" icon="rocket" cta="Open page" />
  <Card title="Docker images and packaging" href="/docker-images-and-packaging" icon="package" cta="Open page" />
</Columns>
