...
<Columns cols={3}>
  ...
  <Card title="Team invite troubleshooting" href="/help-center/troubleshooting/cannot-invite-team" icon="help-circle">

    Use the existing troubleshooting guide when documentation work is blocked because a teammate cannot join the project.
...
If a teammate cannot access the project to review or publish docs, see [Troubleshooting: Cannot Invite Team](/help-center/troubleshooting/cannot-invite-team).
