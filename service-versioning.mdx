...
description: How version numbers are stored per service, bumped manually with the repository script, and augmented by CI workflows for image and release tagging.
---
...
<Columns cols={2}>
  ...
  <Card title="Docker packaging" href="/docker-packaging" icon="package" cta="Open page" />
</Columns>