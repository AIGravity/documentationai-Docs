...
Sentry error monitoring and performance tracing is configured in the API service bootstrap. It activates only in production environments and captures 100% of transactions by default. See the [Configuration Reference](/configuration-reference#sentry-tracing-configuration) for Sentry environment variables and tracing settings.
